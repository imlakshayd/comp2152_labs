...
while not input_valid and i in range(5):
    ...
    try:
        ...
        print("Invaild input. Player needs to enter integer numbers for Combat Strength")
        i += 1
        continue
...
while not m_input_valid and i in range(5):
    ...
    # Lab 9: Question 1
    try:
        m_combat_strength = int(input("Enter the monster's Strength (1-6): "))
    except ValueError:
        print("Invaild input. Monster needs to enter integer numbers for Combat Strength")
        i += 1
        continue
